...
class Sistema {
    constructor() {
        ...
        this.usuarios = [ // La idea era tener usuarios registrados en el sistema para la compra, pero ya no dió el tiempo de llegar hasta allá
...
let carrito_limpio = []
let carrito_saved = JSON.parse(localStorage.getItem("saved_cart"))

//Si en el local storage no hay un carrito guardado, entonces se toma el que se tiene en el archivo sistema
//Para eso nos ayudamos del operador Nullish
let carrito = carrito_saved ?? carrito_limpio
